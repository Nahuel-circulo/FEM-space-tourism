        ...
        <>
            <div className="bg-home-mobile md:bg-home-tablet lg:bg-home-desktop bg-cover  font-normal">
                <div className="mx-auto grid place-items-center lg:grid-cols-2 lg:grid-rows-3 min-h-screen w-full max-w-md md:max-w-2xl lg:max-w-6xl">
                    ...
                    <div className=" md:hover:bg-white md:hover:bg-opacity-10 lg:row-span-2 lg:row-start-2  rounded-full md:p-12  transition ease-in-out">
                        <button className=" uppercase font-bellefair font-normal text-black-text text-lg bg-white rounded-full p-9 md:p-14 lg:p-20 aspect-square">
                            Explore
                        </button>
                    </div>
                </div>
